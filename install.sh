...
echo "  CDP_PORT=auto                  Port CDP (defaut: auto = allocation dynamique)"
echo "                                 Mettre un numero (ex: 9222) pour forcer un port fixe"
echo "  CDP_PORT_MIN=9222              Debut de la plage de ports (mode auto)"
echo "  CDP_PORT_MAX=9232              Fin de la plage de ports (mode auto)"
echo "  CHROME_DEBUG_PS_SCRIPT=...     Chemin du script PowerShell"
echo ""
echo "Multi-session :"
echo "  Par defaut, chaque terminal Claude Code obtient son propre Chrome"
echo "  sur un port libre avec un profil dedie (zero conflit entre sessions)."
echo ""
